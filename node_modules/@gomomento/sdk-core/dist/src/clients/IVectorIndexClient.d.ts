...
import { VectorCountItems, VectorUpsertItemBatch, VectorDeleteItemBatch, VectorSearch, VectorSearchAndFetchVectors, VectorGetItemBatch, VectorGetItemMetadataBatch } from '../messages/responses/vector';
import { VectorIndexItem } from '../messages/vector-index';
/**
 * A special value to request all metadata fields.
 */
export declare const ALL_VECTOR_METADATA: unique symbol;
/**
...
export interface IVectorIndexClient extends IVectorIndexControlClient {
    ...
    getItemBatch(indexName: string, ids: Array<string>): Promise<VectorGetItemBatch.Response>;
    getItemMetadataBatch(indexName: string, ids: Array<string>, metadataFields?: Array<string>): Promise<VectorGetItemMetadataBatch.Response>;
}
