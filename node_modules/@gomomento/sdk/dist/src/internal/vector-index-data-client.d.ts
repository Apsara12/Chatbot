...
import { SearchOptions, VectorCountItems, VectorDeleteItemBatch, VectorSearch, VectorSearchAndFetchVectors, VectorIndexItem, VectorUpsertItemBatch, VectorGetItemBatch, VectorGetItemMetadataBatch } from '@gomomento/sdk-core';
...
export declare class VectorIndexDataClient implements IVectorIndexDataClient {
    ...
    getItemBatch(indexName: string, ids: string[]): Promise<VectorGetItemBatch.Response>;
    private sendGetItemBatch;
    getItemMetadataBatch(indexName: string, ids: string[]): Promise<VectorGetItemMetadataBatch.Response>;
