...
const SYSTEM_TEMPLATE = `You just need to give answers relating to the {context} for the given {question} . If the question is out of the context, give the answer as: Sorry! I have no knowledge about {question}. Use three sentences maximum and keep the answer as concise as possible."`;
  ...
  try {
    ...
    while (true) {
      ...
      if (input.toLowerCase() === 'stop') {
        ...
        rl.close();
        return "User has stopped the conversation";
      }

      const chain = RunnableSequence.from([
        {
          context: retriever.asRetriever(),
